...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field skill on 'Alignment'
        db.create_table('pymafia_alignment_skill', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('alignment', models.ForeignKey(orm['pymafia.alignment'], null=False)),
            ('skill', models.ForeignKey(orm['pymafia.skill'], null=False))
        ))
        db.create_unique('pymafia_alignment_skill', ['alignment_id', 'skill_id'])


    def backwards(self, orm):
        # Removing M2M table for field skill on 'Alignment'
        db.delete_table('pymafia_alignment_skill')
