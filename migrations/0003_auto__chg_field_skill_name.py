...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('pymafia_skill', 'name', self.gf('django.db.models.fields.CharField')(max_length=25))

    def backwards(self, orm):

        # Changing field 'Skill.name'
        db.alter_column('pymafia_skill', 'name', self.gf('django.db.models.fields.CharField')(max_length=8))
