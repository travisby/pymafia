...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GameClassification'
        db.create_table('pymafia_gameclassification', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('classification', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pymafia.Classification'])),
        ...
        db.send_create_signal('pymafia', ['GameClassification'])


    def backwards(self, orm):
        # Deleting model 'GameClassification'
        db.delete_table('pymafia_gameclassification')
    ...
    models = {
        ...
        'pymafia.alignment': {
            ...
            'skill': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['pymafia.Skill']", 'symmetrical': 'False', 'blank': 'True'})
        },
        ...
        'pymafia.game': {
            ...
            'classification': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['pymafia.Classification']", 'through': "orm['pymafia.GameClassification']", 'symmetrical': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'pymafia.gameclassification': {
            'Meta': {'object_name': 'GameClassification'},
            'classification': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['pymafia.Classification']"}),
